...
const InstalledApps = () => {
    ...
    const handleUninstall = (app) => {
        ...
        toast.warning(`${app.companyName} is uninstalled`, {
            autoClose: 2000
        });
    };
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 space-y-4">
            ...
            {installApps.map((app) => (
                <div key={app.id} className="card bg-base-100 shadow-md p-4 py-6 gap-4">
                    <div className='flex justify-between items-center'>
                        ...
                        <button
                            ...
                            className='flex gap-1.5 items-center bg-purple-600 btn text-white'
                        >
                            <RiDeleteBinFill /> Uninstall
                        </button>
                    </div>
                </div>
            ))}
